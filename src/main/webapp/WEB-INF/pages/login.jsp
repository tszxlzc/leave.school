...
<%@ include file="/WEB-INF/pages/common/include_tag.jsp" %>
<%@ include file="/WEB-INF/pages/common/page_var.jsp" %>
<!DOCTYPE html>
<html>
<head>
<title><%=pageTitle%>-用户登录</title>
<link rel="stylesheet" type="text/css" href="/static/css/common_green.css"/>
...
<style type="text/css">
	...
	body {
	background: url(<s:url value='/static/images/gray_bg.png'/>) 0 0 repeat-y #F6F6F6;
	}
</style>
...
<body>
	...
	<div class="rounded table">
			...
			<div class="attention rounded">
						...
						<form id="form1" action="<s:url value='/login'/>" method="post">
